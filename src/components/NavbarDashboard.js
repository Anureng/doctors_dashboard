...
//             {showPopup && (
//                 <div className='fixed top-16 right-4 shadow-gray-500  items-center bg-white shadow-lg rounded-lg p-4'>
...
//                         nav("/")
//                     }}>
//                         <p className='cursor-pointer flex gap-2 '> <ImSwitch className='mb-2  text-center '
//                         />Logout</p>
//                     </div>
//                 </div>
//             )}
